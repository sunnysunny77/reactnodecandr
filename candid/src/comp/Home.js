    ...
    return (
      <React.Fragment>
        ...
        <section className="welcome">
          ...
          <div id="w2">
            <h2 onClick={this.scr}>{this.state.m2}</h2>
          </div>
        </section>
        ...
        <section className="vid ">
          ...
          <span
            ...
            onClick={() => this.vid("v1")}
          >
            {this.state.v1} <PlayCircleOutlineIcon className="iv" />
          </span>
          ...
          <span
            ...
            onClick={() => this.vid("v2")}
          >
            {this.state.v2} <PlayCircleOutlineIcon className="iv" />
          </span>
          ...
          <span
            ...
            onClick={() => this.vid("v1")}
          >
            {this.state.v3} <PlayCircleOutlineIcon className="iv" />
          </span>
          ...
          <span
            ...
            onClick={() => this.vid("v2")}
          >
            {this.state.v4} <PlayCircleOutlineIcon className="iv" />
          </span>
