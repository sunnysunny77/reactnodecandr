...
app.post('/api-home', function (req, res) {
  res.json({
    Home_Svg: dataHome[0].Home,
    Carousel_One: dataHome[1].Home,
    Carousel_Two: dataHome[2].Home,
    Quote_Heading: dataHome[3].Home,
    Quote: dataHome[4].Home,
    Card_Heading_One: dataHome[5].Home,
    Card_One: dataHome[6].Home,
    Card_Heading_Two: dataHome[7].Home,
    Card_Two: dataHome[8].Home,
    Card_Heading_Three: dataHome[9].Home,
    Card_Three: dataHome[10].Home,
    Card_Heading_Four: dataHome[11].Home,
    Card_Four: dataHome[12].Home,
    Url_One: dataHome[13].Home,
    Card_Heading_Five: dataHome[14].Home,
    Card_Five: dataHome[15].Home,
    Url_Two: dataHome[16].Home,
    Card_Heading_Six: dataHome[17].Home,
    Card_Six: dataHome[18].Home,
    Url_Three: dataHome[19].Home,
    Url_Button: dataHome[20].Home,
    Enquiries_Title: dataHome[21].Home,
    Select_Placeholder: dataHome[22].Home,
    Submitt_Form: dataHome[23].Home,
