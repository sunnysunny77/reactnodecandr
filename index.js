...
app.post('/api-home', function (req, res) {
  res.json({
    ...
    Carousel_One: dataHome[2].Home,
    Carousel_Two: dataHome[3].Home,
    Quote_Heading: dataHome[4].Home,
    Quote: dataHome[5].Home,
    Card_Heading_One: dataHome[6].Home,
    Card_One: dataHome[7].Home,
    Card_Heading_Two: dataHome[8].Home,
    Card_Two: dataHome[9].Home,
    Card_Heading_Three: dataHome[10].Home,
    Card_Three: dataHome[11].Home,
    Card_Heading_Four: dataHome[12].Home,
    Card_Four: dataHome[13].Home,
    Url_One: dataHome[14].Home,
    Card_Heading_Five: dataHome[15].Home,
    Card_Five: dataHome[16].Home,
    Url_Two: dataHome[17].Home,
    Card_Heading_Six: dataHome[18].Home,
    Card_Six: dataHome[19].Home,
    Url_Three: dataHome[20].Home,
    Url_Button: dataHome[21].Home,
    Enquiries_Title: dataHome[22].Home,
    Select_Placeholder: dataHome[23].Home,
    Submitt_Form: dataHome[24].Home,
